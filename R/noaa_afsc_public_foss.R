#' @title Public data from FOSS for EBS walleye pollock, yellowfin sole, and red king crab from 1982 to present
...
#' @format A data frame with 45651 observations on the following 37 variables.
#' \describe{
...
#'   \item{\code{srvy}}{Survey. Abbreviated survey names. The column 'srvy' is associated with the 'survey' and 'survey_definition_id' columns. Northern Bering Sea (NBS), Southeastern Bering Sea (EBS), Bering Sea Slope (BSS), Gulf of Alaska (GOA), Aleutian Islands (AI).}
