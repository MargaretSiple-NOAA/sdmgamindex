...
```{r species-cpue-distribution, eval = TRUE, echo = FALSE, fig.cap="2023 species distribution relative densities (size) and bottom temperature (color). ", fig.width=6.5}
...
aic %>% 
  ...
  flextable::flextable() %>% 
  flextable::width(j = "model", width = 3, unit = "in")
...
# strsplit(x = idw$extrapolation.stack$aa, split = "_")
...
figure <- ggplot() +
    ...
    geom_sf(data = idw$extrapolation.stack %>% 
              dplyr::filter(grepl(x = aa, pattern = unique(dat$facet_group)[i])),
            mapping = aes(fill = var1.pred),
            na.rm = FALSE,
            show.legend = TRUE,
            color = NA) +
    ggplot2::facet_wrap(. ~ aa) +
    # ggplot2::facet_grid(cols = vars(group), rows = vars(Year)) +
    coord_sf() +
  ...
  ggsave(filename = paste0("vigD_model_fit_idw_", unique(dat$facet_group)[i], ".png"),
         path = here::here("inst"),
         plot = figure,
         width = 6.5, height = 10)
}
...
```{r survey-figure1, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_maps_walleye pollock.png")))
```

```{r survey-figure1-design, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_maps_walleye pollock-design.png")))
```

```{r survey-figure2, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_maps_yellowfin sole.png")))
```

```{r survey-figure2-design, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_maps_yellowfin sole-design.png")))
```

```{r survey-figure3, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_maps_red king crab.png")))
```

```{r survey-figure3-design, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_maps_red king crab-design.png")))
```
...
```{r sim_gam, echo=TRUE, eval=FALSE}
...
# par(mfrow=c(2,2))
save(sims, ests, file = here::here("inst","vigD_model_sims.Rdata"))
```
