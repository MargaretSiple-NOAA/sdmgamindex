...
```{r survey-figure-timeseries, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_timeseries.png")))
```
...
```{r predict_point, eval = FALSE, echo = FALSE}
...
```{r predict_idw, eval = FALSE, echo = FALSE}
...
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_idw_walleye pollock.png")))
```

```{r survey-figure2, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_idw_yellowfin sole.png")))
```

```{r survey-figure3, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_fit_idw_red king crab.png")))
```
...
```{r sim-1, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_sim_walleye pollock.png")))
```

```{r sim-2, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_sim_yellowfin sole.png")))
```

```{r sim-3, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_sim_red king crab.png")))
```
...
png(filename = here::here("inst","vigD_model_simsest_plot.png"),
...
```{r simest-3, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("inst", paste0("vigD_model_simsest_plot.png")))
```
