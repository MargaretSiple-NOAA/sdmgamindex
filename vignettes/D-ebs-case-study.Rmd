---
title: "{sdmgamindex} case study with and without covariates for Eastern Bering Sea"
date: "`r format(Sys.Date(), format='%B %d %Y') `"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{{sdmgamindex} case study with and without covariates for Eastern Bering Sea}
