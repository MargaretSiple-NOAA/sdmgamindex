...
## Spatiotemporal effect + all of the above
...
Review console output to help verify convergence, and whether there were an adequate number of basis functions (k). If you compare this to the `gam.check()` results from the GAM above with no spatiotemporal effects,
